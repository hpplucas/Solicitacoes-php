...
<body>
    <form method="POST" action="verifica.php" class="verificalogin">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Sistema de Chamados - Login</h3>
                        </div>
                        <div class="panel-body">
                            <form role="form">
                                <fieldset>
                                    ...
                                    <button type="submit" href="cadastrologin.php" class="btn btn-lg btn-success btn-block">Login</button>
